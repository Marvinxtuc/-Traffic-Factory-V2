...
def run_release_check(*, env_path: str | Path, base_url: str, run_tests: bool = True) -> dict[str, Any]:
...
def main() -> None:
    ...
    result = run_release_check(env_path=args.env_file, base_url=args.base_url, run_tests=not args.skip_tests)
